      ...
      <nav class="mt-2">
       ...
       <li class="nav-item">
         <a href="showdata.php" class="nav-link">
           <img src="dist/img/user2.png" style="margin-right: 9px;">
                <p>
                  Users
                </p>
          </a>
         ...
         <a href="contactdata.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
             <img src="dist/img/problemsolving.png" style="margin-right: 8px;">
              <p>
                Problem Status
          ...
          <li class="nav-item">
            <a href="userpostt.php" class="nav-link">
                      <img src="dist/img/request.png">
              <p>
                  Verify Document
              </p>
            </a>
