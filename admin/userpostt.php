...
<div class="container">
    ...
    <tbody>
      ...
      $sql = "SELECT * FROM userpost WHERE status='0'";
      $link = $conn->query($sql);
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      ...
      <div class="col-sm-3">
        ...
        <a href="accept.php?id=<?php echo $rd['id']; ?>&op=1&email=<?php echo $rd['email']; ?>"><button type='button' class='btn' name='accept'><img src="dist/img/check.png"> </button></a>
        <a href="accept.php?id=<?php echo $rd['id']; ?>&op=2&email=<?php echo $rd['email']; ?>"><button type='button' class='btn' name='reject'><img src="dist/img/cancel.png"></button></a>
